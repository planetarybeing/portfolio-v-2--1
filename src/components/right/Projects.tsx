  ...
  return (
    <section ref={ref} className="mb-16" id="projects">
      ...
      <Card>
        ...
        <p className="font-light leading-7 mb-6">Social Media App (Passion Project)</p>
        {renderTags([
          "React",
          "TypeScript",
          "Node.js",
      ...
      <Card>
        ...
        <p className="font-light leading-7 mb-6">Airbnb Clone</p>
        {renderTags(["React", "Node.js", "Tailwind CSS", "Supabase", "PostgreSQL", "Stripe API" ])}
        <div className="mt-6 flex flex-col items-center">
          <button
