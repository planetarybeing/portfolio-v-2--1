    ...
    return (
        <Card>
            ...
            <ul className="mb-4 grid grid-cols-2 gap-x-2">
                <li className="font-light leading-7 pb-2">• Empathy and Emotional Intelligence</li>
                <li className="font-light leading-7">• Self Awareness</li>
                <li className="font-light leading-7 pt-4">• Excellent Communication / Listening Skills</li>
